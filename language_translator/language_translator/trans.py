...
# Define target languages with full forms
target_languages = [
    ('Spanish', 'es'),
    ('French', 'fr'),
    ('German', 'de'),
...
# Select target language with full names
target_language = st.selectbox(
    "Select Target Language",
    options=[name for name, code in target_languages]
)

# Map selected language to its code
language_code = dict(target_languages)[target_language]
